...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1><i class="fas fa-building me-2"></i>Nova Pessoa Jurídica</h1>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('pessoa-juridica.store') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('user_id') is-invalid @enderror" 
                        ...
                        @foreach($users as $user)
                            @if($user->tipo_usuario === 'pessoa_juridica' && !$user->pessoaJuridica)
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('cnpj') is-invalid @enderror" 
                           id="cnpj" name="cnpj" value="{{ old('cnpj') }}" maxlength="14" required>
                    @error('cnpj')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control @error('inscricao_estadual') is-invalid @enderror" 
                           id="inscricao_estadual" name="inscricao_estadual" value="{{ old('inscricao_estadual') }}" maxlength="20">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control @error('inscricao_municipal') is-invalid @enderror" 
                           id="inscricao_municipal" name="inscricao_municipal" value="{{ old('inscricao_municipal') }}" maxlength="20">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('representante_legal') is-invalid @enderror" 
                           id="representante_legal" name="representante_legal" value="{{ old('representante_legal') }}" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('cpf_representante') is-invalid @enderror" 
                           id="cpf_representante" name="cpf_representante" value="{{ old('cpf_representante') }}" maxlength="11" required>
            ...
            <div class="d-flex justify-content-end gap-2">
                <a href="{{ route('pessoa-juridica.index') }}" class="btn btn-secondary">Cancelar</a>
